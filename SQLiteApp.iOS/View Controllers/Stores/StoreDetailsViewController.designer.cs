...
{
	[Register ("StoreDetailsViewController")]
	partial class StoreDetailsViewController
	{
		[Outlet]
		...
		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		MonoTouch.UIKit.UIButton _deleteButton { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		MonoTouch.UIKit.UIButton _editButton { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (_orderDetailsButton != null) {
				_orderDetailsButton.Dispose ();
				_orderDetailsButton = null;
			}
			if (_phoneNum != null) {
				_phoneNum.Dispose ();
				_phoneNum = null;
